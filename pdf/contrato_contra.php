...
FROM
pago
INNER JOIN cronograma ON cronograma.id_pago = pago.id_pago
where pago.id_ficha_enfoque=".$id_enfoque;
$resultado = $conn->query($query); 
foreach ( $resultado as $key=>$rows) {
$cronograma[$key]=$rows["cuo_montocuota"];
...
<p><b>CLÁUSULA TERCERO:</b> El CONSULTOR y EL ASESORADO convienen que el pago por el cumplimiento de las obligaciones para ELABORAR LA TESIS Y/O PROYECTO es la suma  S/. ".$monto.",00 soles, que será cancelados de la siguiente manera:<br>
Por mutuo acuerdo en (4) cuotas: <br>
•  La primera parte S/. ".$cronograma[0].",00 Soles se cancelará a la firma del presente contrato.<br>
•  La segunda parte S/. ".$cronograma[1].",00 Soles se cancelará al contra entrega del proyecto de tesis.<br>
•  La tercera parte S/. ".$cronograma[2].",00 Soles se cancelará al momento de dar inicio al desarrollo.<br>
•  La cuarta parte S/. ".$cronograma[3].",00 se cancelará a la entrega del borrador de tesis.<br>
...
<b>CLÁUSULA DECIMO:</b> Cualquier modificación de los términos pactados en el presente contrato, se ejecutarán de mutuo acuerdo, debiendo formalizarse mediante la suscripción de la addenda respectiva. En caso de que, el Asesorado cambie su tema y/o enfoque, establecida en la FICHA DE ENFOQUE; el monto adicional será señalado en dicha addenda, juntamente con su nuevo tema y/o enfoque.<br>
...
Estando ambas partes de acuerdo firman el presente en señal de aceptación.</h5><br><br>
                            ...
                            <br><br><br>
                             ...
                             <tr>
                               <td width='10%'></td>
                             <td width='40%'> <img style='width=150px;' src='firma.jpg'/></td>
