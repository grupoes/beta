...
if(isset($data)){
    if(is_object($data)) {
      $id_captacion=$data->id_captacion;
...
<input type="hidden" name="id_captacion" value="<?php echo $id_captacion; ?>">
	<div class="row">
		<div class="form-group">
			<label class="control-label col-lg-2">Nombre de la Captacion<span class="text-danger">*</span></label>
				<div class="col-lg-10">
