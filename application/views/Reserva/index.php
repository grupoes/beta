    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center form-title">Registrar Asesoria en Skype</h4>
        </div>
            ...
            <div class="form-group">
              <form id="loginForm">
                ...
                <div class="form-group has-feedback">
                  <label>Nombres </label>
                  <input class="form-control" placeholder="Nombres Completos" id="nombre" name="nombre" type="text" autocomplete="off"  />
               ...
               <div class="col-md-12">
                <div class="form-group has-feedback">
                  ...
                  <input class="form-control" placeholder="Apellidos Completos" id="apellido" type="text" name="apellido" autocomplete="off" />
              ...
              <div class="col-md-12">
                <div class="form-group has-feedback">
                  ...
                  <input class="form-control" placeholder="numero de celular" id="telefono" name="telefono" type="email" autocomplete="off"  />
               ...
               <div class="col-md-12">
                <div class="form-group has-feedback">
                  <label>Email</label>
                  <input class="form-control" placeholder="Correo Electronico" id="correo" name="correo" type="email" autocomplete="off"  />
               ...
               <div class="col-md-12">
                <div class="form-group has-feedback">
                  ...
                  <input class="form-control" placeholder="Skype" id="skype" type="text" name="skype"  autocomplete="off"  />
               ...
               <div class="col-md-12">
                ...
                <div class="form-group">
                  <center><button class="btn btn-primary" type="button" id="boton_enviar" onclick="enviar()">Enviar</button></center>
                </div>
...
function enviar()
{
  ...
  $.post("<?php echo base_url()?>Reserva/reservar_skype",$("#loginForm").serialize(),function(data)
  {
      ...
      toastr.options = {
       ...
       toastr["success"]("Se reservo correctamente", "se envio un mensaje de confirmacion a su correo");
       $("#login").modal("hide");
            $("#nombre").val("");
      $("#apellido").val("");
      $("#correo").val("");
         ...
         dayClick: function(date, jsEvent, view) 
         {
           ...
           if(data!=0){
            ...
            $("#id_sede").val($("#sede").val());
              $.post("<?php echo base_url(); ?>Reserva/verificar",{"fecha":date.format(),"id_sede":$("#sede").val()},function(data1){
              ...
              toastr["error"]("Seleccione una sede por favor");
          }
         }
