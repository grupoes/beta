...
<input type="hidden" name="id_tipo_enfoque" value="<?php echo $id_tipo_enfoque; ?>">
	<div class="row">
		<div class="form-group">
			<label class="control-label col-lg-2">Nombre de Tipo de enfoque<span class="text-danger">*</span></label>
				<div class="col-lg-10">
	...
	<div class="row">
	 <div class="form-group">
      ...
      <center>
      	 ...
      	 <button type="button" class="btn btn-danger" onclick="reload_url('Enfoque','mantenimiento')");">Cancelar</button>
      	 </center>
      </div>
</form>
	</div>
